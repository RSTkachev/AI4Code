...
class OrderPredictionModel(nn.Module):
    def __init__(self, model_name, hidden_dim, dropout_prob=0.1):
    ...
    def forward(self, input_ids1, att_mask1, cell_type1, input_ids2, att_mask2, cell_type2):
        with torch.no_grad():
            embedding1 = self.model(input_ids1, attention_mask=att_mask1).pooler_output
            embedding2 = self.model(input_ids2, attention_mask=att_mask2).pooler_output
