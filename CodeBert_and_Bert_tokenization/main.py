...
if __name__ == "__main__":
    ...
    valid_dataset = TrainValCellDataset("../AI4Code_data/train/", valid_data_short, code_tokenizer, text_tokenizer, 128)
    ...
    test_dataset = TestCellDataset("../AI4Code_data/train/", test_data_short, code_tokenizer, text_tokenizer, 128)
